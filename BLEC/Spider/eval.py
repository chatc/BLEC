...
orginal_data_path = "../../test/spider/raw/"
...
result_json_path = '../../snowball/multi_dataset_samples.json'.format(eval_type)

def data_to_components(data_path, eval_type):
...
def extract_translated_sqls(mapping_path, origin_templates):
    ret = {}
...
if __name__ == '__main__':
    if not LOAD:
        question_query_pairs, detailed_train_pdq = data_to_components(orginal_data_path, eval_type)
