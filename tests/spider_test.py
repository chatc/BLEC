...
import os
from BLEC.Spider.utils import *

eval_type = 'test'

orginal_data_path = "spider/raw/"
mapping_path = "spider/preprocessed/{}.json".format(eval_type)
raw_test_path = "spider/raw/{}.json".format(eval_type)
result_json_path = 'multi_dataset_samples.json'.format(eval_type)
